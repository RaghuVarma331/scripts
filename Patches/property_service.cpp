...
static void SetSafetyNetProps() {
     ...
     InitPropertySet("ro.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.product.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.system.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.vendor_dlkm.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.system_ext.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.system_dlkm.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.odm.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.vendor.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.odm_dlkm.build.fingerprint", "google/cheetah/cheetah:13/TQ2A.230505.002/9891397:user/release-keys");
     InitPropertySet("ro.build.description", "cheetah-user 13 TQ2A.230505.002 9891397 release-keys");
     InitPropertySet("ro.product.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.system.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.build.display.id", "TQ2A.230505.002");
     InitPropertySet("ro.vendor_dlkm.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.system_ext.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.system_dlkm.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.odm.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.vendor.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.odm_dlkm.build.id", "TQ2A.230505.002");
     InitPropertySet("ro.build.version.security_patch", "2023-05-05");
     InitPropertySet("ro.vendor.build.security_patch", "2023-05-05");
}
