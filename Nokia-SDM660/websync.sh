...
echo
echo "| Device       |   Download Link                                 |"
echo "| -----------: | :---------------------------------------------- |"
echo "| Nokia 6.1 Plus ( Latest build )          | [**$DRGPEZIP**]($DRGPELINK)|"
echo "| Nokia 7 Plus ( Latest build )          | [**$B2NPEZIP**]($B2NPELINK)|"
echo "| Nokia 6.1 ( Latest build )          | [**$PL2PEZIP**]($PL2PELINK)|"
echo "| Nokia 7.1 ( Latest build )          | [**$CTLPEZIP**]($CTLPELINK)|"
echo
echo "### LineageOS 17.1 for Nokia phones"
echo
echo "| Device       |   Download Link                                 |"
echo "| -----------: | :---------------------------------------------- |"
echo "| Nokia 6.1 Plus ( Latest build )          | [**$DRGLOSZIP**]($DRGLOSLINK)|"
echo "| Nokia 7 Plus ( Latest build )          | [**$B2NLOSZIP**]($B2NLOSLINK)|"
echo "| Nokia 7.1 ( Latest build )          | [**$CTLLOSZIP**]($CTLLOSLINK)|"
echo
echo "### Aosip Derpfest for Nokia phones"
echo
echo "| Device       |   Download Link                                 |"
echo "| -----------: | :---------------------------------------------- |"
echo "| Nokia 6.1 Plus ( Latest build )          | [**$DRGDERPZIP**]($DRGDERPLINK)|"
echo "| Nokia 7 Plus ( Latest build )          | [**$B2NDERPZIP**]($B2NDERPLINK)|"
echo "| Nokia 6.1 ( Latest build )          | [**$PL2DERPZIP**]($PL2DERPLINK)|"
echo "| Nokia 7.1 ( Latest build )          | [**$CTLDERPZIP**]($CTLDERPLINK)|"
echo
