#!/bin/sh
sourceforge=https://sourceforge.net/projects/ctl-sprout/files/LineageOS
...
forum_url=https://forum.xda-developers.com/nokia-7-1/development/rom-lineageos-17-0-t4019915
