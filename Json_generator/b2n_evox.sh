#!/bin/sh
sourceforge=https://sourceforge.net/projects/b2n-sprout/files/EvolutionX
...
forum_url=https://forum.xda-developers.com/nokia-7-plus/development/rom-evolution-x-3-3-t4011603
