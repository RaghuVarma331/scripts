#!/bin/sh
sourceforge=https://sourceforge.net/projects/ctl-sprout/files/EvolutionX
...
forum_url=https://forum.xda-developers.com/nokia-7-1/development/rom-evolution-x-3-5-t4020515
