#!/bin/sh
sourceforge=https://sourceforge.net/projects/b2n-sprout/files/ExtendedUI
...
forum_url=https://forum.xda-developers.com/nokia-7-plus/development/rom-extended-ui-t4048887
