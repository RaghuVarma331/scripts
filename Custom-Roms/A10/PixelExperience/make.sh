...
L7()
{
    ...
    git clone https://$gitpassword@github.com/Nokia-SDM660/android_device_nokia_Onyx.git -b ten-pe device/nokia/Onyx
    export SELINUX_IGNORE_NEVERALLOWS=true
...
L8()
{
    ...
    rm -r device/nokia
    rm -r out/target/product/*
    git clone https://$gitpassword@github.com/Nokia-SDM660/android_device_nokia_Plate2.git -b ten-pe device/nokia/Plate2
    export SELINUX_IGNORE_NEVERALLOWS=true
