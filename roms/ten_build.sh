...
LINEAGE-SOURCE()
{
    ...
    git clone https://$gitpassword@github.com/RaghuVarma331/Os_Updates.git -b pixel-ten packages/apps/Os_Updates    
...
TWRP-P-INSTALLER()
{
    ...
    cd ..
    cd SLD_sprout 
    sshpass -p $password rsync -avP -e ssh twrp-3.3.1-0-SLD_sprout-9.0* raghuvarma331@frs.sourceforge.net:/home/frs/project/sld-sprout/TWRP/PIE/2020-02-05
    cd ..
    cd DDV_sprout
    sshpass -p $password rsync -avP -e ssh twrp-3.3.1-0-DDV_sprout-9.0* raghuvarma331@frs.sourceforge.net:/home/frs/project/ddv-sprout/TWRP/PIE/2020-02-05
    cd .. 
...
menuvar=("BasicSetup" "pe" "lineageos" "evox" "ext" "oxygen" "twrp" "Black_Caps-Edition" "all_roms" "Exit")
