#!/bin/sh
sourceforge=https://sourceforge.net/projects/ctl-sprout/files/PixelExperience
...
forum_url=https://forum.xda-developers.com/nokia-7-1/development/rom-pixel-experience-t4019933
