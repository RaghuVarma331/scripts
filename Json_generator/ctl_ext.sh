#!/bin/sh
sourceforge=https://sourceforge.net/projects/ctl-sprout/files/ExtendedUI
...
forum_url=https://forum.xda-developers.com/nokia-7-1/development/rom-extended-ui-t4048929
