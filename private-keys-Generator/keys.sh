...
openssl genrsa -3 -out temp.pem 2048
openssl req -new -x509 -key temp.pem -out bluetooth.x509.pem -days 10000 -subj "/C=$C/ST=$ST/L=$L View/O=Android/OU=Android/CN=Android/emailAddress=$emailAddress"
openssl pkcs8 -in temp.pem -topk8 -outform DER -out bluetooth.pk8 -nocrypt
shred --remove temp.pem
