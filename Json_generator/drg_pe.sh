#!/bin/sh
sourceforge=https://sourceforge.net/projects/drg-sprout/files/PixelExperience
...
forum_url=https://forum.xda-developers.com/nokia-6-1-plus/development/rom-pixel-experience-t3985853
